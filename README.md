...
9. [pair,tuple](pair_tuple.md)
10. [queue,deque](queue.md)
11. [STL functions](stl_functions.md)
12. [struct, class](struct_class.md)
13. [2-тын тоолол,bitwise operators](bit_operator.md)
14. [vector, iterator](vector.md)
15. [string](string.md)
16. [stack](stack.md)
